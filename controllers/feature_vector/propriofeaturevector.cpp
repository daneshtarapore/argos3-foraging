...
{
  if(m_sSensoryData.m_rTime == 1.0f)
    {
      //std::cout << "init values";
        ...
        // the time window is in ticks and the maxlinearspeed is in cm / tick and not cm / sec
        ...
        m_fSquaredDistThreshold         = (0.15 * m_sRobotData.MaxLinearSpeed * ((Real)m_iLongTimeWindowLength)); // the time window is in ticks and the maxlinearspeed is in cm / tick and not cm / sec
        m_fSquaredDistThreshold        *= m_fSquaredDistThreshold; //in cm^2
  ...
  /*std::cout << "MLS " << m_sRobotData.MaxLinearSpeed << std::endl << std::endl;
      std::cout << "m_iLongTimeWindowLength " << (Real)m_iLongTimeWindowLength << std::endl << std::endl;
      std::cout << "((Real)m_sRobotData.iterations_per_second))" << ((Real)m_sRobotData.iterations_per_second) << std::endl << std::endl;
      std::cout << " Squared dist threshold " << m_fSquaredDistThreshold << std::endl << std::endl;	*/
...
void CProprioceptiveFeatureVector::ComputeFeatureValues()
{
    ...
    /*if(m_sSensoryData.m_unRobotId == 0)
    {
       std::cout << std::endl << "Proprioceptive estimated distance (10s) " << sqrt(m_fEstimated_SquaredDist_LongTimeWindow) << " cm " << std::endl << std::endl;
       std::cout << std::endl << "Distance threshold (10s) " << sqrt(m_fSquaredDistThreshold) << " cm " << std::endl << std::endl;       
       }*/
}
